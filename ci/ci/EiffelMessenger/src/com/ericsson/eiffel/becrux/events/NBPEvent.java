...
/**
 * New Baseline Promoted response event.
 *
 *
 */
public class NBPEvent extends Event {
	...
	public NBPEvent() {
		super(NBPEvent.class.getSimpleName());
	}
	...
	public EventValidationResult validate() {
		...
		if(products != null && baselines != null && products.size() != baselines.size())
