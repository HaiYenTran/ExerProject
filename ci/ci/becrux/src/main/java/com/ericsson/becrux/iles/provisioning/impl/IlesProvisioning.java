...
public class IlesProvisioning extends BaseProvisioning implements Provisioning {
    ...
    private static String EXECUTE_COMMAND_PATTERN = "{0} -c delete -l {1} {2} {3} {4} \n {0} -c add -l {1} {2} {3} {4}";
    ...
    public String generateExecuteCommand() throws Exception {
        ...
        String additionalArgs = getProperties().getAdditionalArgs();
        if (additionalArgs == null || additionalArgs.isEmpty())
            commandParams.add("");
        else
            commandParams.add(additionalArgs);
