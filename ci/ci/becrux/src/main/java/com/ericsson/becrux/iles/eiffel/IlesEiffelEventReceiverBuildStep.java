...
public class IlesEiffelEventReceiverBuildStep extends EiffelEventReceiverBuildStep {
    ...
    /**
     * Constructor.
     * @param tag tag name to receive events with specific tag
     * @param receivedEventTypes type of event to receive events of specific types
     * @param secondaryBindings eiffel secondary bindings
     * @param timeout event polling timeout
     * @param customBindings true/false to use custom eiffel event
     */
    ...
    /**
     * Gets the default received event type from IlesEventFactory
     * @return default base event
     */
