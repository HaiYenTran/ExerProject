...
public class IlesTestExec implements TestExec {
    ...
    private static final String REAL_TEST_EXECUTE_COMMAND = "java -jar {0} -c {1} -e {2} -t {3} {4} {5} {6} {7}";
    ...
    public String generateExecuteCommand() throws Exception {
		...
		*/
        ...
        commandParams.add(properties.getAdditionalArgs() == null || properties.getAdditionalArgs().isEmpty()?
                "" : properties.getAdditionalArgs());
