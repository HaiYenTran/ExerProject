...
public class IlesTestExecTest {
    ...
    public void testGenerateExecuteCommand() {
        try {
            ...
            properties.setRealTestExec(true);
            properties.setAdditionalArgs("-max_timeout 500");
            testExec = new IlesTestExec(properties);
            assertTrue(testExec.generateExecuteCommand().contentEquals("java -jar ./ -c /tmp/INT.tgz -e testExecutionServer -t VISE0308  -g testGatewayServer   -max_timeout 500"));
