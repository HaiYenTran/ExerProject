...
public class BTFEvent extends Event {
    ...
    public List<Version> getBaselines() {
        return Collections.unmodifiableList(baselines.stream().map(Version::createReleaseVersion).collect(Collectors.toList()));
    }

    public void setBaselines(@Nonnull List<Version> baselines) {
