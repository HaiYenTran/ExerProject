...
public class JsonComponentDaoTest {
    ...
    public void testSerializationAndDeserialization() throws IOException {
        Component node = new BaseComponentImpl(Version.createReleaseVersion("1.0"));
    ...
    public void testSerializationAndDeserializationRState() throws Exception {
        Component node = new BaseComponentImpl(Version.createReleaseVersion("R1A"));
    ...
    public void testSavingState() throws IOException {
        ...
        Component defaultNode = new BaseComponentImpl(Version.createReleaseVersion("2.0"), Component.State.NEW_BUILD);
        this.dao.saveComponent(defaultNode);
        try {
            this.dao.saveComponentState(new BaseComponentImpl(Version.createReleaseVersion("2.0")), Component.State.BASELINE_APPROVED);
            assertTrue(this.dao.validate());
        } catch (Exception e) {
    ...
    public void testLoadNewestComponent() throws Exception {
        ...
        for (int i = 0; i < numOfComponents; ++i) {
            newestComponent = new BaseComponentImpl(Version.createReleaseVersion("1.0." + i));
    ...
    public void testLoadNewestComponentByState() throws Exception {
        ...
        for (Component.State state : Component.State.values()) {
            for (int i = 0; i < numOfEach; ++i) {
                newestComponent = new BaseComponentImpl(Version.createReleaseVersion(state.ordinal() + ".0." + i));
    ...
    public void testRemoveComponent() throws Exception {
        Component component;
        for (Component.State state : Component.State.values()) {
            component = new BaseComponentImpl(Version.createReleaseVersion("1.0." + state.ordinal()));
    ...
    public void testLoadComponentState() throws Exception {
        Component component = new BaseComponentImpl(Version.createReleaseVersion("1.0.0"));
