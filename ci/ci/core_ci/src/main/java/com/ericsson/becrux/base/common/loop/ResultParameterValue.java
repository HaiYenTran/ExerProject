...
public class ResultParameterValue extends NwftParameterValue {
    ...
    public ResultParameterValue(String processType, PhaseStatus processStatus, Map<String, String> details, Map<TestStatus, Integer> testScore, String sourcePath){
    ...
    public String getValue() {
        ...
        stringResult.append("[Source Path: ").append(this.sourcePath).append("] ");
        stringResult.append("] ");
