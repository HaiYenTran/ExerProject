...
public abstract class Component implements Comparable<Object> {
    ...
    //Build state
    private State state;
    //Full path of new test suite package
    private String artifact;
    //Version of IMS software package
    ...
    /**
     * Constructor.
     * @param version Version of IMS software package
     */
    public Component(@Nonnull String version) {
        this();
     ...
     * Constructor.
     * @param version Version of IMS software package
     * @param artifact Full path of new test suite package
     */
    public Component(@Nonnull String version, String artifact) {
        this(version);
     ...
     */
    public Component(@Nonnull String version, State state) {
        this(version);
        this.state = state;
    }
