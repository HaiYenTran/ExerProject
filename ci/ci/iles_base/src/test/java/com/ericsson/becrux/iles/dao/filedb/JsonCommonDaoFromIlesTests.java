...
public class JsonCommonDaoFromIlesTests {
    ...
    public void testBasicFindingNodesBaselineConfirmed() throws IOException {
        ...
        try {
            ...
            assertEquals("1.0.1", mtas.getVersion().getVersion());
    ...
    public void testFindingTheLatestMtasReadyForBaselineLoopFromMultiplePossible() throws IOException {
        ...
        try {
            ...
            assertNotNull(mtas);
            assertEquals("9.0", mtas.getVersion().getVersion());
        }
        finally {
            if(myTempDir != null)
                FileUtils.deleteDirectory(myTempDir);
    ...
    private Collection<Event> createEventsQueue() {
        ...
        Component node = new Mtas(Version.createReleaseVersion("21.0"));
        ...
        Component node2 = new Ibcf(Version.createReleaseVersion("2.0"));
        ...
        for(int i = 0; i < e3.getProducts().size(); ++i)
            baselines.add(Version.createReleaseVersion("1.0"));
    ...
    private List<Component> prepareMtases(File dir) {
        ...
        list.add(new Mtas(Version.createReleaseVersion("9.0"), Component.State.BASELINE_APPROVED));
        list.add(new Mtas(Version.createReleaseVersion("10.0"), Component.State.BASELINE_CANDIDATE));
        list.add(new Mtas(Version.createReleaseVersion("3.0"), Component.State.BASELINE_APPROVED));
        list.add(new Mtas(Version.createReleaseVersion("6.0"), Component.State.BASELINE_APPROVED));
        list.add(new Mtas(Version.createReleaseVersion("6.1"), Component.State.NEW_BUILD));
        list.add(new Mtas(Version.createReleaseVersion("11.0"), Component.State.NEW_BUILD));
    ...
    private void setUpStandardTestFiles(File dir) {
        ...
        Component m1 = new Mtas(Version.createReleaseVersion("1.0"));
        m1.setState(Component.State.BASELINE_APPROVED);
        nodeList.add(m1);
        Component m11 = new Mtas(Version.createReleaseVersion("1.0.1"));
        m11.setState(Component.State.BASELINE_APPROVED);
        nodeList.add(m11);
        Component m2 = new Mtas(Version.createReleaseVersion("1.1"));
        m2.setState(Component.State.BASELINE_CANDIDATE);
        nodeList.add(m2);
        Component m3 = new Mtas(Version.createReleaseVersion("2.0"));
        m3.setState(Component.State.NEW_BUILD);
        nodeList.add(m3);

        Component c2 = new Cscf(Version.createReleaseVersion("6.3.0"));
        c2.setState(Component.State.BASELINE_CANDIDATE);
        nodeList.add(c2);

        Component c3 = new Cscf(Version.createReleaseVersion("6.4"));
        c3.setState(Component.State.NEW_BUILD);
        nodeList.add(c3);

        Component mr1 = new Pcscf(Version.createReleaseVersion("0.2"));
        mr1.setState(Component.State.BASELINE_APPROVED);
        nodeList.add(mr1);

        Component mr2 = new Pcscf(Version.createReleaseVersion("0.3"));
        mr2.setState(Component.State.BASELINE_CANDIDATE);
        nodeList.add(mr2);

        Component mr3 = new Pcscf(Version.createReleaseVersion("1.0"));
        mr3.setState(Component.State.NEW_BUILD);
        nodeList.add(mr3);

        Component s1 = new Ibcf(Version.createReleaseVersion("1.0.2"));
        s1.setState(Component.State.BASELINE_APPROVED);
        nodeList.add(s1);

        Component s2 = new Ibcf(Version.createReleaseVersion("1.0.3"));
        s2.setState(Component.State.BASELINE_CANDIDATE);
        nodeList.add(s2);

        Component s3 = new Ibcf(Version.createReleaseVersion("2.1.0"));
        s3.setState(Component.State.NEW_BUILD);
        nodeList.add(s3);

        Component i1 = new Int(Version.createReleaseVersion("1.0"));
        i1.setArtifact("/tmp/INT_latest1.tar.gz");
        i1.setState(Component.State.BASELINE_APPROVED);
        nodeList.add(i1);

        Component i2 = new Int(Version.createReleaseVersion("2.0"));
