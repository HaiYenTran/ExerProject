...
public class EventSchedulerComparatorTests {
	...
	public void CorrectOrdering() {
		...
		i1.setBaseline(Version.createReleaseVersion("1.0"));
		i2.setBaseline(Version.createReleaseVersion("2.0"));
		queue.pushEvent(i1);
		queue.pushEvent(i2);
		...
		b1Baselines.add(Version.createReleaseVersion("1.0"));
		b1Baselines.add(Version.createReleaseVersion("2.0"));
		b1Baselines.add(Version.createReleaseVersion("1.0"));
		b1Baselines.add(Version.createReleaseVersion("1.0"));
		b2Baselines.add(Version.createReleaseVersion("1.0"));
		b2Baselines.add(Version.createReleaseVersion("1.0"));
		b2Baselines.add(Version.createReleaseVersion("1.0"));
		b2Baselines.add(Version.createReleaseVersion("1.0"));
