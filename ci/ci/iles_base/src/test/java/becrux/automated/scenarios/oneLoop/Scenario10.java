...
//
//public class Scenario10 extends Scenario implements TemplateForScenario{
//
//	private JenkinsJobsSetting jobs;
//	private Node node = new Mtas(Version.create("0.9"));
//
//	public Scenario10(JenkinsRule rule, JenkinsJobsSetting jobs, EiffelEventSender sender) {
