...
//
//public class Scenario4 extends Scenario implements TemplateForScenario{
//
//	private JenkinsJobsSetting jobs;
//	private Node node1 = new Mtas(Version.create("2.0"));
//
//	public Scenario4(JenkinsRule rule, JenkinsJobsSetting jobs, EiffelEventSender sender) {
