...
import com.ericsson.becrux.iles.eiffel.events.*;
...
public class EventSchedulerComparator implements Comparator<Event>, Serializable {
    ...
    private int compareVersion(Version v1, Version v2, boolean ascending) {
        if (v1 == null && v2 == null)
            return 0;
    ...
    private int compareVersion(List<Version> v1, List<Version> v2, boolean ascending) {
        if (v1 == null && v2 == null)
            return 0;
