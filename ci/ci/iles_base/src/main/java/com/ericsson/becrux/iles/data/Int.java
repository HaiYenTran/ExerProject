...
public class Int extends Component implements Comparable<Object> {
    ...
    public Int(@Nonnull Version version) {
        super(version);
        setInstallable(false);
    }

    public Int(@Nonnull Version version, String artifact, List<String> parameters) {
    ...
    public Int(@Nonnull Version version, State state) {
        super(version, state);
        setInstallable(false);
    }
